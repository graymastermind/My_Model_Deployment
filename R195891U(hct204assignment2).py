# -*- coding: utf-8 -*-
"""HCT204Assignment2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Xtd_nooIaQWXGze39FtWSjilXtX_62d2
"""
...
dataset = pd.read_csv(
    '/content/drive/My Drive/Colab Notebooks/DataSets/datasets_13996_18858_WA_Fn-UseC_-Telco-Customer-Churn.csv')
dataset.sample(5)
...
models = []
models.append(('XGB',
               GradientBoostingClassifier(random_state=12345, learning_rate=0.05, max_depth=5, min_samples_split=2,
